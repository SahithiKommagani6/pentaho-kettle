...
public class PurRepositoryUtilsTest {
  ...
  @Test
  public void hasServerUrlReturnsFalseWhenUrlIsEmpty() {
    RepositoryMeta meta = new FakePurRepoMeta( "", "USERNAME_PASSWORD" ) {
    };
    assertFalse( PurRepositoryUtils.hasServerUrl( meta ) );
  }

  @Test
  public void hasServerUrlReturnsFalseWhenUrlIsWhitespace() {
    RepositoryMeta meta = new FakePurRepoMeta( "   ", "USERNAME_PASSWORD" ) {
    };
    assertFalse( PurRepositoryUtils.hasServerUrl( meta ) );
  }
  ...
  abstract static class FakePurRepoMeta implements RepositoryMeta {
    ...
    public RepositoryMeta clone() {
      return new FakePurRepoMeta( url, authMethod ) {
      };
    }
